...
def biog(bfac_path,beld4):
    ...
    ag=['NLCD_37', 'NLCD_38', 'MODIS_12', 'MODIS_14', 'Alfalfa', 'Alfalfa_ir', 'Barley', 'Barley_ir', 'CornGrain',
    ...
    for land_use in beld4.keys():
                   
        if land_use not in bfac['beld4_name'].unique():
              print('#####################')
              print(f'!!!! Warning land use {land_use} not defined in b360fac file') 
              print('#####################')    
        else:   
            
           land_use_km2=beld4[land_use]

...
speciate_output_dir='/data/dusan/emPY/data/outputs-speciation-2019_d02_lok_vyk'
...
list_inv_area_spec=['SVK_resHeat_15_85']
...
#set input directory
time_variate_input_dir='/data/dusan/emPY/data/outputs-speciation-2019_d02_lok_vyk'
# set the output directory
time_variate_output_dir='/data/oko/dusan/emisie/modelovanie_2019/outputs-final-2019_d02_lok_vyk'
#name of output files in form out_file_name-datum
out_file_name='EM_2019_d02_lok_vyk'

...
to_domain_output_directory='/data/dusan/emPY/data/outputs-to_domain-2019_ala_kon'
...
speciate_output_dir='/data/dusan/emPY/data/outputs-speciation-2019_d02'
...
#set input directory
time_variate_input_dir='/data/dusan/emPY/data/outputs-speciation-2019_d02'
# set the output directory
time_variate_output_dir='/data/oko/dusan/emisie/modelovanie_2019/outputs-final-2019_d02_all'
#name of output files in form out_file_name-datum
out_file_name='EM_2019_d02_all'

...
to_domain_output_directory='/data/dusan/emPY/data/outputs-to_domain-skusanie'
...
#####
#set input directory
speciate_input_dir='/data/dusan/emPY/data/outputs-to_domain-skusanie'
# set the output directory
speciate_output_dir='/data/dusan/emPY/data/outputs-speciation-skusanie'
...
#list_inv_area_spec=['invetory_1', 'inventory_2']
...
#set input directory
time_variate_input_dir='/data/dusan/emPY/data/outputs-speciation-skusanie'
# set the output directory
time_variate_output_dir='/data/dusan/emPY/data/outputs-final-skusanie'

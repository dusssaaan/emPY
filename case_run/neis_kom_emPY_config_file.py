...
speciate_output_dir='/data/dusan/emPY/data/outputs-speciation-2019_d02_neis_kom'
...
list_inv_point_spec=['kominy_v1']


##############################
#setting for time_variate
#set input directory
time_variate_input_dir='/data/dusan/emPY/data/outputs-speciation-2019_d02_neis_kom'
# set the output directory
time_variate_output_dir='/data/oko/dusan/emisie/modelovanie_2019/outputs-final-2019_d02_neis_kom'
#name of output files in form out_file_name-datum
out_file_name='EM_2019_d02_neis_kom'
